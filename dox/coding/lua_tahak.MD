...
* [Kolekce](#kolekce)
  * [Table jako 1D pole](#table-jako-1d-pole)
  * [Table jako asociativní pole (dictionary)](#table-jako-asociativní-pole-dictionary)
  * [Table jako množina (set)](#table-jako-množina-set)
* [Řetězce](#řetězce)
  * [Zjištění indexu podřetězce](#zjištění-indexu-podřetězce)
  * [Hledání podřetězců podle vzoru](#hledání-podřetězců-podle-vzoru)
  * [String split?](#string-split)
  * [Vyzobání hodnot z řetězce à la `sscanf`](#vyzobání-hodnot-z-řetězce-à-la-sscanf)
* [Převody](#převody)
* [Skoky](#skoky)
...
local dict = {
    ...
    "Item1",
    [2] = "Value2",
    --"Item2", -- Nelze, znamenalo by duplicitní index ([2] už je obsazeno)
}
...
Lua nemá metodu pro splitování řetězce. Pokud chceme splitovat podle znaku / sady znaků, použijeme opět `string.gmatch`, které lze v tomto případě chápat jako opak splitu. Chceme-li splitovat podle mezery, hledáme vše, co neobsahuje mezeru a má libovolnou nenulovou délku:
...
Split podle konkrétního podřetězce / výrazu je komplikovanější, můžeme zkusit funkci:
...
local left, right = text:match("(%a+)%s+(%a+)") -- text:match("𝑥") je zkrácený zápis pro string.match(text, "𝑥")
