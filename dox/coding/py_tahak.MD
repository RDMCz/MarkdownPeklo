...
with open(PATH / "filename.txt", "w", encoding="utf-8") as f_out:  # "w" jako write / "a" jako append
    f_out.write("Příliš žluťoučký kůň úpěl ďábelské ódy 🤓.")

with open(PATH / "filename.txt", "r", encoding="utf-8") as f_in:  # "r" jako read
    contents = f_in.read()
```
